            ...
            <div className={styles.recentProjectsContainer}>
                ...
                <div className={styles.projects}>
                    <Card sx={{ width: 350, height: 350 }}>
                        ...
                        <CardActions>
                            <Button size="small" variant='contained' style={{ backgroundColor: 'black', color: 'white' }}
                                onClick={() => window.open('https://github.com/pattersondev/Sneaker-Related')}>See the code</Button>
                        </CardActions>
                    </Card>
                    ...
                    <Card sx={{ width: 350, height: 350 }}>
                        ...
                        <CardActions>
                            <Button size="small" variant='contained' style={{ backgroundColor: 'black', color: 'white' }}
                                onClick={() => window.open('https://github.com/pattersondev/StripeProject')}>See the code</Button>
                        </CardActions>
                    </Card>
                    ...
                    <Card sx={{ width: 350, height: 350 }}>
                        ...
                        <CardActions>
                            <Button size="small" variant='contained' style={{ backgroundColor: 'black', color: 'white' }}
                                onClick={() => window.open('https://github.com/pattersondev/happify')}>See the code</Button>
                        </CardActions>
                    </Card>
